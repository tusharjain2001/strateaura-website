...
export default function ThinkingBehindVeil() {
  return (
    <section className="bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-5 py-14 sm:px-8 lg:px-[255px] lg:py-[63px]">
        <div className="relative overflow-hidden rounded-[12px] bg-gradient-to-b from-gold to-gold-dark px-8 py-10 sm:px-12 lg:px-[48px] lg:py-[54px]">
          ...
          <p className="relative text-[20px] font-bold text-white/65 sm:text-[24px] lg:text-[20px]">
            The thinking behind
          </p>
          <h2 className="relative text-[44px] leading-[1.24] font-bold text-white sm:text-[52px] lg:text-[30px]">
            VEIL™
          </h2>
          ...
          <p className="relative mt-4 max-w-[626px] text-[18px] leading-normal text-white sm:text-[20px] lg:mt-2 lg:max-w-[482px] lg:text-[16px] lg:leading-[1.24] lg:[&>span]:inline">
          ...
          <CtaPill as="a" href="/webinar" variant="whiteOutline" size="compactLg" className="relative mt-8 lg:mt-6">
