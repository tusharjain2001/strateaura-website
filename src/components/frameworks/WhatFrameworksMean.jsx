...
export default function WhatFrameworksMean() {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(77deg,rgba(247,244,238,0)_6%,#e8d9ae_94%)]">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col lg:min-h-[776px] lg:flex-row">
        ...
        {/* Copy column */}
        <div className="flex flex-1 flex-col justify-center gap-6 px-5 py-10 sm:px-8 lg:gap-8 lg:px-[66px] lg:py-16 xl:pr-[95px]">
          <div>
            ...
            <p className="mt-5 max-w-[580px] text-[clamp(1.0625rem,1.7vw,1.4375rem)] leading-normal text-black/60 lg:mt-6">
          ...
          <div className="max-w-[757px] rounded-[4px] bg-gold px-6 py-7 sm:px-8 sm:py-8 lg:px-[56px] lg:py-[52px]">
