 ...
 *
 * The 120px of white above the band is Figma's gap between the last Insights
 * card (it ends at y=8766) and the navy rect (y=8886). It sits on the section
 * so the navy stays scoped to the inner wrapper instead of filling the gap.
 */
export default function MobileEdge() {
  return (
    <section className="bg-white pt-[120px]">
      <div className="relative overflow-hidden bg-navy pt-[108.76px] pb-[71.24px]">
